...
export const projects = [
    {
      ...
      description: [
        ...
        "Built with Django REST Framework (DRF) on the backend and React for the frontend."
    ],
    ...
    },
    {
      ...
      image: bursaryApp,
      description: [
        "An online platform where students can apply for various bursaries.",
        "Applications are reviewed and approved by system administrators, after which funds are disbursed.",
        "Developed using Django and HTML5 for a streamlined backend-driven experience."
        ],
    ...
    },
    {
      ...
      description: [
        "A React-based tool designed for companies to efficiently allocate budgets across different departments based on available funds.",
        "Offers a simple and intuitive interface for managing financial planning."
      ],
      technologies: ["React"],
    ...
    },
    {
      ...
      image: notesApp,
      description: [
        "A lightweight React application that enables users to manage to-do lists and take notes.",
        "Ideal for tracking daily tasks and boosting productivity."
      ],
      technologies: ["React"],
